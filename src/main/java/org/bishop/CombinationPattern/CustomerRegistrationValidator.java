...
import org.bishop.CombinationPattern.CustomerRegistrationValidator.*;
...
public interface CustomerRegistrationValidator extends Function<Customer, ValidationResult> {
    ...
    static CustomerRegistrationValidator isCustomerAgeVerfied()
    {
    ...
    default  CustomerRegistrationValidator or(CustomerRegistrationValidator other)
    {
        return customer -> {
          ValidationResult result =this.apply(customer);
          return result.equals(ValidationResult.SUCCESS) ? result : other.apply(customer);
        };
    }
